      ...
      return (
        <StyledInput className={"inputWithIcon"}>
            ...
            /> 
              ...
              <button id="search-button"  className="right-icon" disabled={this.state.submitDisabled} onClick={this.sendText} >
                <svg
              ...
              <div id="clear-text" className="left-icon" onClick={this.clearText}>
